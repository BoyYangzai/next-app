  ...
  ({ className = "", variant = "default" }) => {
    ...
    const navItems = [
      ...
      },
      {
        ...
        shortLabel: t("navigation.themeShort"),
        icon: "🎨",
      ...
      },
      {
        ...
        shortLabel: t("navigation.mobxShort"),
        icon: "🔢",
      ...
      },
      {
        ...
        shortLabel: t("navigation.seoShort"),
        icon: "📊",
      ...
      },
      {
        ...
        label: t("navigation.errorBoundary"),
        description: t("navigation.errorBoundaryDesc"),
        shortLabel: t("navigation.errorBoundaryShort"),
        icon: "🚨",
